...
(function ($) {
  ...
  Selectpicker.prototype = {
    ...
    createDropdown: function () {
      ...
      '<input type="text" class="form-control" autocomplete="off" style="border-color: rgba(229, 103, 103, 0.8);box-shadow: 0 1px 1px rgba(0, 0, 0, 0.075) inset, 0 0 8px rgba(126, 239, 104, 0.6);outline: 0 none;"' +
