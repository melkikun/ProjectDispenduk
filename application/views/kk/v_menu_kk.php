...
<html>
    <head>
        ...
        <title>Menu Kartu Keluarga</title>
    </head>
    <body>
        ...
        <div id="contentArea">
            <div class="row">
                <div class="col-md-12">
                    <header class="content-header">Menu Layanan Kartu keluarga</header>
                </div>
            </div>

            <div class="row">
                <div class="col-md-2 col-md-offset-3 panel-button-besar" >
                    <a href="<?php echo base_url(); ?>kk/registrasi">
                        <i class="fa fa-registered"></i>
                        <span class="main-icon-text" style="font-size: 17px;">Registrasi</span>
                        <span class="main-icon-text" style="font-size: 17px;">Kartu Keluarga Baru</span>
                    </a>
                </div>

                <div class="col-md-2 panel-button-besar" >
                    <a href="<?php echo base_url(); ?>kk/upload">
                ...
                <div class="col-md-2 panel-button-besar" >
                    <a href="<?php echo base_url(); ?>kk/monitor">
