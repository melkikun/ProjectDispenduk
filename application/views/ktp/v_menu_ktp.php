...
<body>
	...
	<div id="contentArea">
		<div class="row">
			<div class="col-md-12">
				<header class="content-header">Menu Layanan KTP</header>
			</div>
		</div>
		
		<div class="row">
			<div class="col-md-2 col-md-offset-3 panel-button-besar" >
                            <a href="<?php echo base_url();?>ktp/registrasi">
					<i class="fa fa-registered"></i>
					<span class="main-icon-text">Registrasi</span>
					<span class="main-icon-text">KTP Baru</span>
				</a>
			</div>
			
			<div class="col-md-2 panel-button-besar" >
				<a href="<?php echo base_url();?>ktp/upload">
			...
			<div class="col-md-2 panel-button-besar" >
				<a href="<?php echo base_url();?>ktp/monitor">
